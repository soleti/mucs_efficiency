...
h_theta_mc_clone.SetFillStyle(3002)
...
pad_top.Draw()
pad_top.cd()
g_theta_stat.SetMarkerStyle(20)
g_theta_sys.SetFillStyle(3002)
g_theta_sys.SetFillColor(kGray+2)
...
g_theta_sys.Draw("2")
g_theta_stat.Draw("P")
pt = TPaveText(0.14,0.08,0.44,0.16, "ndc")
...
leg.AddEntry(g_theta_stat,"Data - stat. only","ep")
leg.AddEntry(g_theta_sys,"Data - stat. #oplus sys.","f")
...
h_phi_mc_clone.SetFillStyle(3002)
...
pad_top.Draw()
pad_top.cd()
g_phi_stat.SetMarkerStyle(20)
g_phi_sys.SetFillStyle(3002)
g_phi_sys.SetFillColor(kGray+2)
h_phi_mc.Draw("hist")
...
h_l_mc_clone.SetFillStyle(3002)
...
pad_top.Draw()
pad_top.cd()
g_l_stat.SetMarkerStyle(20)
g_l_sys.SetFillStyle(3002)
g_l_sys.SetFillColor(kGray+2)
h_l_mc.Draw("hist")
