...
from ROOT import TFile, TCanvas, TH2F, TH1F, gDirectory, kRed, kGreen, gStyle, TPad, TLine, TLegend, gPad, TPaveText
...
h_theta_ratio = h_theta.Clone()
h_theta_ratio.Divide(h_theta_mc)
h_theta_ratio.GetYaxis().SetRangeUser(0.61,1.39)
...
h_phi_ratio = h_phi.Clone()
h_phi_ratio.Divide(h_phi_mc)
h_phi_ratio.GetYaxis().SetRangeUser(0.61,1.39)
...
h_l_ratio.GetYaxis().SetRangeUser(0.61,1.39)
